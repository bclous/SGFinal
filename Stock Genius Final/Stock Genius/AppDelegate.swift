...
//  Stock Genius
//
//  Created by Brian Clouser on 3/23/17.
...
@UIApplicationMain
class AppDelegate: UIResponder, UIApplicationDelegate, IntroVCDelegate {
    ...
    func restoreComplete(success: Bool)
    {
    ...
    lazy var persistentContainer: NSPersistentContainer = {
        ...
        */
        let container = NSPersistentContainer(name: "Stock_Genius")
